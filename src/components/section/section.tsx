...
export function Section({ items }: IsectionInfos) {
    return (
        <section className="flex flex-col items-center mt-20">
            <div>
                <h1 className="text-4xl ml-5 md:ml-0 md:text-5xl font-bold text-start text-[var(--text-primary)] font-mono">Cursos <span className="text-[var(--color-primary)]">Recomendados!</span></h1>
